...
def get_filters():
    ...
    while True :
           day=input('choose a day(all,monday,tuesday,wednesday,thursday,friday,saturday,sunday):\n').lower()
           if day in days :
               break
           else:
               print('invalid input')       
...
def station_stats(df):
    ...
    print('the most frequent combination is :',df['comb'].mode()[0])                
...
def trip_duration_stats(df):
    ...
    print('travel time mean is:',df['Trip Duration'].mean())
...
def user_stats(df,city):
    ...
    # TO DO: Display earliest, most recent, and most common year of birth
        ...
        print('the recent year of birth is',df['Birth Year'].max())
        print('the earliest year of birth is',df['Birth Year'].mode()[0])
    else:
...
def display_data(df):
    #display 5 rows of data based on user input
    print('\n row data is available to check....\n')
    i=0
    user_input=input('\nWould you like to display five rows of data?....(type "yes" or "no")\n')
